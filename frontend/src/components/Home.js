                        ...
                        <div className="card">
                            <div className="card-body">
                                <form>
                                    ...
                                    <button onClick={createPoll} className="btn btn-dark">Create Voting Poll</button>
                                </form>
                            </div>
                        </div>
                    </div>
        ...
        <>
            <div className="row mt-5" style={{ alignItems: 'center' }}>
                <div className="col-md-6 mb-4">
                    ...
                    <h4>Keep it transparent, no rigging and cheating.</h4>
                    ...
                    {!walletConnected ? 
                        ...
                        <div className="mb-4">
                            <p className='font-weight-bold'>Available Voting Polls: {numVotingPolls}</p>
                            <div className="">
                                <button className="btn btn-success" onClick={() => setSelectedTab("Create Poll")}>Create Polls</button> {" "}
                                <button className="btn btn-secondary" onClick={() => setSelectedTab("View Polls")}>View Polls</button>
                            </div>
                        </div>
                    }
                </div>
                <div className="col-md-6">
                    <img src="images/vote.jpg" className="img-fluid" alt="" />
                </div>
            </div>

            {walletConnected && renderTabs()}
        </>
    );
}
